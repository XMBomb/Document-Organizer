...
public class ArgumentInterpreter {
	...
	public void parseArguments(final String[] args) throws ParseException {
		final Option help = new Option("h", "help", false, "Print help and exit");
		final Option version = new Option("v", "version", false, "Print version and exit");
		final Option silent = new Option("s", "silent", false, "Use silent mode");
